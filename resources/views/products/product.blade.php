		...
		<div class="container">
			<div class="row product-info-outer">
				<div id="productPrevNext" class="hidden-xs hidden-sm">
					<a href="#" class="product-prev"><img src="{{asset('')}}images/product/product-2.jpg" alt="" /></a>
					<a href="#" class="product-next"><img src="{{asset('')}}images/product/product-3.jpg" alt="" /></a>
				</div>
				<div class="col-sm-12 col-md-12 col-lg-12 col-xl-8">
					<div class="row">
						<div class="col-sm-4 col-md-4 col-lg-4 col-xl-4 hidden-xs">
							<div class="product-main-image">
								<div class="product-main-image__item"><img class="product-zoom" src="{{asset('storage')}}/{{$products->image}}" data-zoom-image="{{asset('storage')}}/{{$products->image}}" alt="" /></div>
								<div class="product-main-image__zoom"></div>
							</div>
							<div class="product-images-carousel">
								<ul id="smallGallery">
									<li><a href="#" data-image="{{asset('storage')}}/{{$products->image}}" data-zoom-image="{{asset('storage')}}/{{$products->image}}"><img src="{{asset('storage')}}/{{$products->image}}" alt="" /></a></li>
									<li><a href="#" data-image="{{asset('storage')}}/{{$products->image}}" data-zoom-image="{{asset('storage')}}/{{$products->image}}"><img src="{{asset('storage')}}/{{$products->image}}" alt="" /></a></li>
									<li><a href="#" data-image="{{asset('storage')}}/{{$products->image}}" data-zoom-image="{{asset('storage')}}/{{$products->image}}"><img src="{{asset('storage')}}/{{$products->image}}" alt="" /></a></li>
									<li><a href="#" data-image="{{asset('storage')}}/{{$products->image}}" data-zoom-image="{{asset('storage')}}/{{$products->image}}"><img src="{{asset('storage')}}/{{$products->image}}" alt="" /></a></li>
									<li><a href="#" data-image="{{asset('storage')}}/{{$products->image}}" data-zoom-image="{{asset('storage')}}/{{$products->image}}"><img src="{{asset('storage')}}/{{$products->image}}" alt="" /></a></li>
						...
						<div class="product-info col-sm-8 col-md-8 col-lg-8 col-xl-8">
							<div class="wrapper hidden-xs">
								<div class="product-info__sku pull-left color-dark">SKU: <strong class="text-color">{{$products->id}}</strong></div>
							...
							<div class="wrapper visible-xs">
								<div class="product-info__sku pull-left">SKU: <strong>{{$products->id}}</strong></div>
							...
							<div class="price-box product-info__price"><span class="price-box__new">${{$products->price}}</span> <span class="price-box__old">${{$products->original_price}}</span></div>
							...
							<ul class="options-swatch options-swatch--color options-swatch--lg">
								...
								<li idcolor="{{$color->color}}" class="licolor col-{{$color->color}}" style="background: {{$color->color}}"><a ><span class="swatch-label"></span></a></li>
								@endforeach
							</ul>
							<div class="wrapper">
							...
							<div class="wrapper">
								...
								<div class="pull-left">
									...
									<div class="number input-counter">
									    ...
									    <input class="quantity" type="text" value="1" size="5"/>
				...
				<div class="custom-product-block col-xl-4 visible-xl">
					...
					<div class="vertical-carousel vertical-carousel-2 with-checkbox offset-top-40">
						<div class="vertical-carousel__item">
							...
							<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('')}}images/product/product-80x100-3.jpg" alt=""></a></div>
						...
						<div class="vertical-carousel__item">
							...
							<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('')}}images/product/product-80x100-4.jpg" alt=""></a></div>
							<div class="vertical-carousel__item__title">
								<h2><a href="#">Quis nostrud exercit ation</a></h2>
							</div>
							<div class="price-box">$26.00<span class="price-box__old">$28.00</span></div>
						...
						<div class="vertical-carousel__item">
							...
							<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('')}}images/product/product-80x100-1.jpg" alt=""></a></div>
							<div class="vertical-carousel__item__title">
								<h2><a href="#">Quis nostrud exercit ation</a></h2>
							</div>
							<div class="price-box">$26.00<span class="price-box__old">$28.00</span></div>
						...
						<div class="vertical-carousel__item">
							...
							<div class="vertical-carousel__item__image pull-left"><a href="#"><img src="{{asset('')}}images/product/product-80x100-2.jpg" alt=""></a></div>
							<div class="vertical-carousel__item__title">
								<h2><a href="#">Quis nostrud exercit ation</a></h2>
							</div>
							<div class="price-box">$26.00<span class="price-box__old">$28.00</span></div>
	...
	<section class="content">
		<div class="container">
			...
			<div class="title-with-button">
				...
				<h2 class="text-left text-uppercase title-under pull-left">SIMILAR PRODUCTS</h2>
			</div>
			<!-- /title --> 
			<!-- carousel -->
					...
					<div class="product">
						<div class="product__inside">
							...
							<div class="product__inside__image">
								<a href="{{asset('product')}}/{{$fullproduct->id}}"> <img style="width: 270px;height: 270px" src="{{asset('storage')}}/{{$fullproduct->image}}" alt=""> </a> 
								<!-- quick-view --> 
								<a href="{{asset('product')}}/{{$fullproduct->id}}" class="quick-view"><b><span class="icon icon-visibility"></span> View</b> </a> 
								<!-- /quick-view --> 
							</div>
							<!-- /product image --> 
							<!-- product name -->
							<div class="product__inside__name">
								<h2><a href="{{asset('product')}}/{{$fullproduct->id}}">{{$fullproduct->name}}</a></h2>
							</div>
							<!-- /product name -->                 <!-- product description --> 
							<!-- visible only in row-view mode -->
							<div class="product__inside__description row-mode-visible"> {{$fullproduct->description}} </div>
							<!-- /product description -->                 <!-- product price -->
							<div class="product__inside__price price-box">${{$fullproduct->price}}</div>
...
<script type="text/javascript" src="{{mix('js/js-product.js')}}"></script>
<script type="text/javascript">
	...
	jQuery(document).ready(function(){
		jQuery(document).on('click','.licolor',function(e){
			...
			jQuery.ajax({
				type: 'GET',
				url: url+'productDetails/findByColor/'+product_id+ '/'+ idcolor,
